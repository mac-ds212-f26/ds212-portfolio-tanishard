...
#5
diamonds = diamonds%>%
  mutate(price_cat1 = ifelse(price<500, "low", "high"))

diamonds = diamonds%>%
  mutate(price_cat2 = case_when(price<500 ~ "low", price>=500 & price<=1000 ~ "medium", price>1000 ~ "high"))
```
...
ratings1 = fct_relevel(ratings, "Low", "Medium","High")
ratings1
```
