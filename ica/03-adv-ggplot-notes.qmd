...
ggplot(weather, aes(x=dateInYear)) +
  ...
  geom_linerange(aes(ymin=NormalLow, ymax=NormalHigh), color = "#C8B8BA")+
  geom_linerange(aes(ymin=Low, ymax=High), color = "#A90248")+
  geom_vline(month_boundaries, xintercept=month_boundaries$month_boundary, linetype="dashed")+
  theme_classic()
```
...
ggplot(weather, aes(x=dateInYear)) +
  ...
  geom_linerange(aes(ymin=Low, ymax=High), color = "#A90248")+
  geom_vline(month_boundaries, xintercept=month_boundaries$month_boundary, linetype="dashed")+
  scale_x_continuous(breaks = month_boundaries$month_boundary,labels = month_boundaries$month_name) +
  labs(x=NULL)+
  theme_classic()
```
